...
/**
 * Advanced Toner Technician with logging
 */
public class TonerTechnicianAdvanced implements Runnable {
    private final TicketMachineAdvanced ticketMachine;
    private final String name;
    private final int refillAttempts = 3;
    private final SimpleLogger logger;
    
    public TonerTechnicianAdvanced(String name, TicketMachineAdvanced ticketMachine) {
    ...
    @Override
    public void run() {
        logger.info("Started toner maintenance duty");
